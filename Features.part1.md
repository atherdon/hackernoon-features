...
Tight integration with Medium, so that I don’t need to have separate group of followers on Medium and HackerNoon, and don’t have to get readers & followers independently on both platforms.
https://community.hackernoon.com/t/what-are-the-killer-features-youd-like-to-see-in-hacker-noon-2-0/68/49?u=arthur.tkachenko
...
When browsing articles on Medium, sometimes I see a good post, but I forgot to bookmark it.

Later when I want to look for the said article, it’s really hard to look for it especially if I forgot the author and the title, but remember only some specific lines that resonates with me and I want to look at it again.
